...
// Form Result Visuals: Error (MRN-T) Matrix Table
export class ResultErrorTable extends React.Component<Props, State> {
    ...
    render() {
        ...
        return (
            <div>
                <span>Error (MRN-T) Matrix (Meal by Nutrient)</span>
                <Button 
                    bsStyle="link"
                    bsSize="small"
                    onClick={ () => {
